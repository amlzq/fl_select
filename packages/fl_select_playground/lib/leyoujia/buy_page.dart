...
import 'package:fl_select_playground/leyoujia/house_filters_repository.dart';
import 'package:fl_select_playground/leyoujia/house_repository.dart';
import 'package:fl_select_playground/leyoujia/utils.dart';
...
class _BuyPageState extends State<BuyPage> {
        ...
        slivers: [
          ValueListenableBuilder<double>(
            ...
            builder: (context, offset, child) {
              ...
              final foregroundColor = isCollapsed
  ...
  Widget _buildBannerBackground() {
    return SizedBox.expand(
      child: Image.asset('assets/realestate/banner.jpg', fit: BoxFit.cover),
    );
  }
            ...
            PopupSelectBar(
              ...
              selectDelegates: [
                ...
                FlattenSelectDelegate(
                  ...
                  actionBarBuilder:
                      (context, {required onResetTap, required onApplyTap}) {
                        return MyActionBar(
                  ...
                  return ChoiceChip(
                    ...
                    onSelected: (bool selected) async {
                      ...
                      final ok = await _controller.apply(
                        tabIndex: 3,
                        selectedEntryIds: _moreShortcutSelected,
                      );
                      if (!ok) {
  ...
  Widget _buildHouseList(AppLocalizations? l10n) {
    ...
    if (_error != null) {
      return SliverFillRemaining(
        child: Center(child: Text(l10n?.loadError('$_error') ?? '$_error')),
      );
    }
