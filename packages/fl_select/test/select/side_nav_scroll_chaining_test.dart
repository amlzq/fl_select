import 'package:fl_select/fl_select.dart' hide SelectListTile;
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.pumpWidget(
        _harness(outer, _longCategories, maxHeightFactor: 1),
      );
      ...
      expect(
        _innerScrollable(tester).position.pixels,
        greaterThan(0),
